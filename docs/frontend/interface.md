...
В случае ошибки авторизации, полученной от сервера (или другой) или при ошибке построения формы (или другой), после успешного получения данных вывести диалоговое окно с кнопкой Ок, после ее нажатия закрыть приложение.
